/* ===== Visual Enhancement Module =====
   Purpose: Icon injection and visual styling for form fields
   Handles: SVG icon injection, field wrapping, visual enhancements
================================================= */
...
function initVisualEnhancements(rootDoc) {
  if(!rootDoc) rootDoc = document;
  enhanceVisual(rootDoc);
}

// Export visual enhancement functionality
window.QuoteFormConfig = window.QuoteFormConfig || {};
window.QuoteFormConfig.enhanceVisual = enhanceVisual;
window.QuoteFormConfig.initVisualEnhancements = initVisualEnhancements;

export { enhanceVisual, initVisualEnhancements };