/* ===== Step 2 Validation Module =====
   Purpose: Validate Step 2 fields when SUBMIT button is clicked
   Handles: Email/phone/name validation, inline error messages, form submission control
================================================= */

function initStepTwoValidation() {
...
window.QuoteFormConfig.initStepTwoValidation = initStepTwoValidation;

export { initStepTwoValidation };