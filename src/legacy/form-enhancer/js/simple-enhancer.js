// Simple Form Enhancer - Works with direct window.CFG configuration
(function() {
  'use strict';
  ...
  async function loadGoogleMaps() {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=${config.GMAPS_KEY}&libraries=places`;
    script.async = true;
    script.defer = true;
